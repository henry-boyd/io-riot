...
export declare function createRelativeSchema(cmd: string, fileProtocolRoot: string): z.ZodPipe<z.ZodObject<{
    ...
    vite: z.ZodDefault<z.ZodCustom<import("astro").ViteUserConfig, import("astro").ViteUserConfig>>;
    ...
    fonts: z.ZodOptional<z.ZodArray<z.ZodObject<{
        ...
        provider: z.ZodCustom<import("astro").FontProvider<never>, import("astro").FontProvider<never>>;
    ...
    fonts?: {
        name: string;
        cssVariable: string;
        provider: import("astro").FontProvider<never>;
